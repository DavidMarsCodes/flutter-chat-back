...
const { createRoom, getRoomsByUser, deleteRoom, editPositionByRoom, editRoom, getRoomById } = require('../controllers/rooms');
...
router.get('/room/:id', validateJWT, getRoomById );
